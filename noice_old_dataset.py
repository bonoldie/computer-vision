...
_SAM1073_zephyr_R = np.reshape(np.fromstring('0.01841271693051194   0.1666927526546294   0.9858380643274236 0.8662643176653761    0.489685082066562 -0.09897898857301685 -0.4992494237300246    0.855818713223613  -0.1353833110049552', sep=' ', dtype=np.float64), (3, 3))
_SAM1073_zephyr_t = np.fromstring('-81.44194666865684 -32.63020138408148 -36.8722720991269', sep=' ', dtype=np.float64)
